...
class UNet2DConditionModel_Cnet(ModelMixin, ConfigMixin, UNet2DConditionLoadersMixin):
    ...
    def forward(
        ...
        down_block_additional_residuals = (
            down_block_additional_residuals0, down_block_additional_residuals1,
            down_block_additional_residuals2, down_block_additional_residuals3,
            down_block_additional_residuals4, down_block_additional_residuals5,
            down_block_additional_residuals6, down_block_additional_residuals7,
            down_block_additional_residuals8, down_block_additional_residuals9,
            down_block_additional_residuals10, down_block_additional_residuals11,
        )
